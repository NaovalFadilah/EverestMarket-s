...
@section('content')
    <style>
        ...
        .review-image {
            ...
            height: 100px;
            object-fit: cover;
            /* Untuk mengatur gambar agar tidak terdistorsi */
            cursor: pointer;
            /* Agar user tahu gambar bisa diklik */
        }
        ...
        .like-count {
            margin-left: 5px;
            color: black;
            /* Warna default untuk jumlah like */
        }
    </style>
    <!-- Page Preloder -->
    <div id="preloder">
    ...
    <div class="container">
        ...
        <div class="product-detail">
            ...
            <div class="product-info">
                <h2>Prestone Air Radiator Coolant Hijau 3.78 Liter Cairan Pendingin Mobil Motor Antifreeze Original
                </h2>
        ...
        <section class="product-description">
            ...
            <p>This is an excellent product that provides superior comfort and durability. Crafted with premium
                materials, it is designed to last and cater to your style needs.</p>
        ...
        <div class="reviews">
            <div class="review-item">
                ...
                <div class="review-body">
                    ...
                    <p>Alhamdulillah paket coolant telah sampai. Produk Aman packing rapi ga penyok2. Prestone
                        kwality... Rekomendasi tokonya amanah. Puas belanja di sini. Jangan ragu belanja disini.
                        Terimakasih.. selamat menunaikan ibadah puasa.</p>
                    <div class="review-media">
                        <img src="img/ever/2.png" alt="review media" class="review-image" onclick="openPopup(this.src)">
                        <img src="img/ever/prestone.png" alt="review media" class="review-image"
    ...
    <div class="row justify-content-center">
        <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="product__item">
                ...
                <div class="product__item__text">
                    <h6 style="font-size: 12px;">TOP 1 Air Radiator Power Coolant Merah 1 Liter Cairan Pendingin
                        Mobil Motor Pencegah Karat & Korosi</h6>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="product__item sale">
                ...
                <div class="product__item__text">
                    <h6 style="font-size: 12px;">TOP 1 Air Radiator Power Coolant Hijau 1 Liter Cairan Pendingin
                        Mobil Motor Pencegah Karat & Korosi</h6>
                    <a href="#" class="add-cart" style="font-size: 12px;">+ Add To Cart</a>
                    <div class="rating">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="product__item">
                ...
                <div class="product__item__text">
                    <h6 style="font-size: 12px;">Master Air Radiator Coolant Hijau 1 Liter Cairan Pendingin Mobil
                        Motor Pencegah Karat & Korosi Original</h6>
                    <a href="#" class="add-cart" style="font-size: 12px;">+ Add To Cart</a>
                    <div class="rating">
                        <i class="fa fa-star-o" style="font-size: 10px;"></i>
                        <i class="fa fa-star-o" style="font-size: 10px;"></i>
